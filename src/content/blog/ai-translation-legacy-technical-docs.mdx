...
<Mermaid chart={`
graph LR
  A[Source<br/>language] --> B[DeepL<br/>version] --> C[GPT<br/>proofreading] --> D[Select changes<br/>individually]

  %% Define teal-themed styles
  classDef source fill:#e0f7f9,stroke:#00838f,stroke-width:2px,color:#004d40,font-weight:bold,rx:8,ry:8;
  classDef translation fill:#b2ebf2,stroke:#0097a7,stroke-width:2px,color:#004d40,font-weight:bold,rx:8,ry:8;
  classDef proofreading fill:#80deea,stroke:#00acc1,stroke-width:2px,color:#00363a,font-weight:bold,rx:8,ry:8;
  classDef review fill:#4dd0e1,stroke:#00bcd4,stroke-width:2px,color:#002f33,font-weight:bold,rx:8,ry:8;

  %% Apply styles
  class A source;
  class B translation;
  class C proofreading;
  class D review;

  %% Optional: style links (uniform teal)
...
graph LR
  ...
  %% Define teal styles
  classDef input fill:#e0f7f9,stroke:#00838f,stroke-width:2px,color:#004d40,font-weight:bold,rx:8,ry:8;
  classDef decision fill:#b2ebf2,stroke:#0097a7,stroke-width:2px,color:#00363a,font-weight:bold,rx:8,ry:8;
  classDef keep fill:#80deea,stroke:#00acc1,stroke-width:2px,color:#002f33,font-weight:bold,rx:8,ry:8;
  classDef discard fill:#4dd0e1,stroke:#00bcd4,stroke-width:2px,color:#002f33,font-weight:bold,rx:8,ry:8;
