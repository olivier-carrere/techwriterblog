...
flowchart TD
    ...
    F3 c2@--> H2[Brand]
    F3 c3@--> H3[Cylinders]
    F3 c4@--> H4[Viscosity grade]
    F3 c5@--> H5[Price]

    %% Row values (documents)
    H1 --> J@{ shape: docs, label: "Primary oil"}
    H2 --> K@{ shape: docs, label: "A1X"}
    H3 --> L@{ shape: docs, label: "One-cylinder engines"}
    H4 --> M@{ shape: docs, label: "0W-20"}
    H5 --> N@{ shape: docs, label: "$15.00"}
