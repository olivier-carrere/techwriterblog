...
flowchart TD
    ...
    %% Main steps
    B b1@--> F1[Insert title]
    B b2@--> F2[Insert short description]
    B b3@--> F3[Create table with headers: Type, Brand, Cylinders, Viscosity grade, Price]
	B d1@--> H
    ...
    %% Connections between headers and values
    H1 --> J
    H2 --> K
    H4 --> M
    H5 --> N
    ...
    class B topic;
    class F1,F2,F3, step;
    class H1,H2,H4,H5 substep;
    class J,K,M,N documents;
