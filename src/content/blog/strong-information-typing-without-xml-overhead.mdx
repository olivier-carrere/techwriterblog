...
<div className="p-4 mb-4 rounded-lg bg-blue-50 border-l-4 border-blue-600 text-gray-800">
  You can also query the same YAML that powers build-time tables in Astro <strong>via a live API</strong>, with interactive documentation available on <a href="./experimental-astro-api-docs/" className="text-blue-600 hover:underline">Swagger Docs</a>.
</div>
