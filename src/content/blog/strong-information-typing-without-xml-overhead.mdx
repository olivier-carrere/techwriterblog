...
<blockquote>
  You can also query the same YAML that powers build-time tables in Astro <strong>via a live API</strong>, with [interactive documentation](../experimental-astro-api-docs/) available on Swagger Docs.
</blockquote>
