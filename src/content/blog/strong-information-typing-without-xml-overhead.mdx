...
import ToolsListContent from '../../components/ToolsList.astro?raw';
import ToolsTableContent from '../../components/ToolsTable.astro?raw';
...
---
<details>
<summary><strong>DITA reference example</strong></summary>
```xml
...
| Type          | Brand       | Usage                | Viscosity grade |
|---------------|------------|--------------------|----------------|
| Primary oil   | A1X        | One-cylinder engines | 0W-20          |
| Secondary oil | B2Y        | Two-cylinder engines | 5W-30          |
...
1. **Create the YAML file**
   Create a file at **src/data/oil-types.yaml** with the following content:
	...
	---
	<details>
	<summary><strong>oil-types.yaml</strong></summary>
	<pre>
	<code>
	{yamlRaw}
	</code>
...
2. **Create the Astro component**. 
   ...
   Create a file at **src/components/ToolsList.astro** with the following content:
	...
	---
	<details>
	<summary><strong>ToolsList.astro</strong></summary>
	<pre>
	<code>
	{ToolsListContent}
	</code>
