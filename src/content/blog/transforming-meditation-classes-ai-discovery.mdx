...
B --> C[Assign Raw Score 1 to 10 for Theme Daily Life]
C --> D[Gaussian Normalization of Scores]
D --> E[Update YAML Frontmatter with Score]

E --> F{Score Above Threshold?}
F -->|Yes| I[Convert Markdown to LaTeX Chapters]
F -->|No| H[Available Digitally Only]
...
H --> M[Accessible via Digital Platform or AI Exploration]
