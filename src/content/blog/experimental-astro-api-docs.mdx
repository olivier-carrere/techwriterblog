...
<blockquote>
As exemplified in [Strong Information Typing Without XML Overhead](../strong-information-typing-without-xml-overhead/), you can also query the same YAML file powering the API **at build time via Astro**. This allows you to **populate tables, lists, or other components statically**, keeping pages fast and SEO-friendly.
