...
I’ve been experimenting with **self-documenting APIs in Astro**, and you can now **read the API documentation live** on Swagger at:

<a
  href="https://redaction-technique.org/docs"
  target="_blank"
  rel="noopener noreferrer"
  className="inline-block px-4 py-2 rounded-2xl bg-blue-600 text-white font-medium shadow hover:bg-blue-700 transition"
>
  Swagger Docs
</a>
...
The API serves structured content generated from a simple YAML source file.  
The endpoint is available at:

<a
  href="https://redaction-technique.org/api/oil-types"
  target="_blank"
  rel="noopener noreferrer"
  className="inline-block px-4 py-2 rounded-2xl bg-green-600 text-white font-medium shadow hover:bg-green-700 transition"
>
  Oil Types API
</a>
